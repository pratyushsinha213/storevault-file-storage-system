...
//     return (
//         <div className="flex flex-col min-h-screen bg-black text-primary">
//             {/* Header */}
...
const AIChatPage = () => {
    ...
    return (
        <div className="relative flex flex-col min-h-screen overflow-hidden text-primary">
            {/* ✅ Retro Grid */}
            <RetroGrid />

            {/* Header */}
            <div className="px-6 py-4 border-b border-zinc-800 bg-zinc-900/80 backdrop-blur-sm">
                <h1 className="text-xl font-semibold">🤖 AI Chat Assistant</h1>
                <p className="text-sm text-zinc-400">Ask me anything!</p>
            </div>
            ...
            {/* Input */}
            <div className="flex items-center px-4 py-3 border-t border-zinc-800 bg-zinc-900/80 backdrop-blur-sm">
                <Input
                    type="text"
                    className="flex-1 px-4 py-2 text-sm rounded-md outline-none bg-zinc-800 focus:ring-2 focus:ring-blue-500"
                    placeholder="Type your message..."
